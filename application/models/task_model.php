...
class Task_model extends CI_Model
{
  ...
  {
    $this->db->select('tasks.*,projects.*,project_details.*,users.*,clients.*,tags.*');
    $this->db->from('tasks');
    $this->db->join('tags', 'tags.tag_id = tasks.tag_id');
    $this->db->join('projects', 'projects.project_id = tasks.project_id');
    $this->db->join('project_details', 'projects.project_id = project_details.project_id');
    $this->db->join('users', 'users.user_id = tasks.user_id');
    $this->db->join('clients', 'projects.client_id = clients.client_id');
