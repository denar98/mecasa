...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            {color: "#F05B3B", points: data1_points, data: data1, label: "data1"},
            ...
            {color: "#073D5E", bars: {show: true, align: "center", barWidth: 0.25}, data: data4, label: "data4"},
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [ CubaAdminConfig.primary , "#51bb25" ,"#f8d62b" ,"#a927f9" ,"#dc3545", "#F05B3B" , CubaAdminConfig.secondary ]
    });
